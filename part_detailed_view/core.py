...
class PartDetailedView(UserInterfaceMixin, InvenTreePlugin):

    """PartDetailedView - custom InvenTree plugin."""

    # Plugin metadata
    TITLE = "Part Detailed View"
    NAME = "PartDetailedView"
    SLUG = "part-detailed-view"
    DESCRIPTION = "Extend parts view"
