# Part Detailed View- Frontend Code

This directory contains the frontend code for the Part Detailed View plugin.
...
This will compile the frontend into the `../part_detailed_view/static` directory (ready for distribution).
